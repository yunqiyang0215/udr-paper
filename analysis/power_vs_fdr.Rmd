...
1. K = 10, Vj=I.
2. True Us: identity + 5 singletons + 4 unconstrained Us from rinwishart. 
...
4. R = 5, scale of U = 5
5. n.train = c(50, 100, 500, 1e3, 2e3, 5e3)
...
R = 5
s = 5
n.train = c(50, 100, 500, 1e3, 2e3, 5e3)
...
points(output.ed1[[5]]$fdr, output.ed1[[5]]$power, col = 5, type = "b", pch = 20, cex = 0.5)
points(output.ed1[[6]]$fdr, output.ed1[[6]]$power, col = 6, type = "b", pch = 20, cex = 0.5)
legend("topleft", legend = c("n: 50", "n: 100", "n: 500", "n: 1e3", "n: 2e3", "n: 5e3"), 
       col = c(1:6), lty=1)
...
points(output.ted1[[5]]$fdr, output.ted1[[5]]$power, col = 5, type = "b", pch = 20, cex = 0.5)
points(output.ted1[[6]]$fdr, output.ted1[[6]]$power, col = 6, type = "b", pch = 20, cex = 0.5)
legend("topleft", legend = c("n: 50", "n: 100", "n: 500", "n: 1e3", "n: 2e3", "n: 5e3"), 
       col = c(1:6), lty=1)
```
